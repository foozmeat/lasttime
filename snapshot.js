...
target.frontMostApp().mainWindow().tableViews()[1].tapWithOptions({tapOffset:{x:0.40, y:0.20}});
captureLocalizedScreenshot("02-Timeline")

target.frontMostApp().navigationBar().buttons()[1].tap();
target.frontMostApp().mainWindow().tableViews()[1].tapWithOptions({tapOffset:{x:0.40, y:0.10}});
