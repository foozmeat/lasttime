...
- (void)reconfigureForMasterInPopover:(BOOL)inPopover
{
	...
	if (inPopover && !_hiddenPopoverController && !_barButtonItem) {
		...
		_barButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Master", @"Ignore this string") 
		...
		[_hiddenPopoverController setContentViewController:[[UIViewController alloc] init]];
		_hiddenPopoverController = nil;
