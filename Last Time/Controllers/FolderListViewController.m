...
- (void)setEditing:(BOOL)editing animated:(BOOL)animate
{
	...
	NSIndexPath *newRow = [NSIndexPath indexPathForRow:[[self.fetchedResultsController fetchedObjects] count] inSection:0];
	NSArray *paths = [NSArray arrayWithObject:newRow];
